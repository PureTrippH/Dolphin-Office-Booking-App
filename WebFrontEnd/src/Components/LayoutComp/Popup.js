        ...
        <div data-aos="zoom-in" class="popup-background" style={{"position": "fixed", "zIndex": "1", "top": "0px", "left": "0px", "width": "100%", "height": "100%", "backgroundColor": "#7a7978", "opacity": "0.7"}}>
            ...
            "backgroundColor": "#f7c3c1"}}>
                {isFormVisible ? <div data-aos="fade-up">
                    ...
                    <Form style={{"position": "relative", "height": "50%", "margin": "autho"}}></Form>
                    </BaseGrid>
                </div> : null}
                {!isFormVisible ? 
                <div data-aos="zoom-in">
                <Button classes={{root: classes.root}}>X</Button>
                ...
                "padding": "5%"}}>
                    ...
                    <BaseGrid gap="10px">
                        <Button variant="contained" color="primary">Accept Changes</Button>
